 ...
 * file-name prefix. Snapshot entirely independent from cinema (extension: .orion-games.json.gz).
 */
object GamesExportImportManager {
    ...
    fun defaultFileName(): String = GzipJsonExportImport.defaultFileName("orion-games-export", "orion-games.json.gz")
}
