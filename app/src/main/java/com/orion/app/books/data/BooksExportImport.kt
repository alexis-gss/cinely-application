 ...
 * file-name prefix. Snapshot entirely independent from the other domains.
 * Extension of the generated file: .orion-books.json.gz
 */
object BooksExportImportManager {
    ...
    fun defaultFileName(): String = GzipJsonExportImport.defaultFileName("orion-books-export", "orion-books.json.gz")
}
