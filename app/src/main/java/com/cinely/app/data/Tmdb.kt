...
// ---------------- NOUVEAUX MODÈLES DE CRÉDITS, VIDÉOS, PROVIDERS & RECOMMANDATIONS ----------------
...
// ---------------- ÉTENDU POUR DÉTAILS FILM ET SÉRIE ----------------
...
data class EpisodeInfo(
    ...
    val runtime: Int? = null   // durée en minutes, fournie par TMDB sur le detail de saison
)
...
interface TmdbApi {
    ...
    // On utilise append_to_response pour récupérer toutes les infos nécessaires en un seul appel HTTP !
    @GET("movie/{id}")
    ...
    suspend fun getMovieImages(
        @Path("id") id: Int,
        @Query("include_image_language") includeImageLanguage: String = "fr,en,null"
    ): ImagesResponse
